 ...
 * <p/>
 * Created 6/11/12 12:15 PM
 */
public class TribeServices extends BaseService
{
    public Tribe getTribeWithId(long id)
    {
        APIRequest apiRequest = createAPIRequest();

        apiRequest.setRequestType(RequestType.GET);
        apiRequest.setRequestUrl(TribeMethods.GET_WITH_ID);
        apiRequest.setRequestEntityClass(Tribe.class);
        ...
        return (Tribe)apiResponse.getResponse();
    }
}
